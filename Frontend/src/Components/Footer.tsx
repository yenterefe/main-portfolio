            ...
            <div className="flex flex-col md:px-20 py-3 md:flex-row justify-between">
                <div className="flex flex-col md:flex-row md:gap-3">
                    <div className="flex flex-row gap-1">
                        ...
                        <h3 className='text-slate-600'>+1-352-871-1220</h3>
                    </div>
                    <div className="flex flex-row gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        ...
                        <Element name="contact">
                            <a className="hover:font-bold text-blue-400" href="mailto:yenterefe@gmail.com">yenterefe@gmail.com</a>
                        </Element>
                    </div>
                </div>
                <div>
                    <h3 className='text-slate-600'> ©{new Date().getFullYear()}. Yeneneh Terefe. All rights reserved</h3>
                </div>
            </div>
