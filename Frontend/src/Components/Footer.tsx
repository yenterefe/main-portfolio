      ...
      <div className="flex flex-col md:px-20 py-3 md:flex-row justify-between">
        <div className="flex flex-col md:flex-row md:gap-3">
          <div className="flex flex-row gap-1">
            ...
            >
              <path
                d="M6.6 2.2c.5-1 1.8-1.4 2.7-.9l1.9 1.1
          ...
          <div className="flex flex-row gap-1">
            ...
            <Element name="contact">
              <a
                className="hover:font-bold text-blue-400"
                href="mailto:yenterefe@gmail.com"
              >
                yenterefe@gmail.com
              </a>
            </Element>
        ...
        <div>
          <h3 className="text-slate-600">
            {" "}
            ©{new Date().getFullYear()}. Yeneneh Terefe. All rights reserved
          </h3>
        </div>
      </div>
    </div>
