      ...
      <div className="flex justify-center p-20">
        {!isDisplayed ? (
          ...
          <div className="relative">
            <textarea
              className="static h-[200px] w-[300px] md:w-[500px] border-2 border-gray-100 text-slate-600 rounded-sm p-2"
              placeholder="Type your comment..."
            ></textarea>
            <button
              type="submit"
              className="absolute bottom-3 left-55 md:left-105 cursor-pointer  hover:bg-blue-400 hover:scale-125 h-[40px] w-[70px] rounded-full bg-blue-50 border-2 border-blue-100"
