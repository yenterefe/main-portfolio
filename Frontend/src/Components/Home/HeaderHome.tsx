        ...
        <div className="flex flex-row justify-between py-3 bg-gradient-to-r from-blue-200 via-yellow-100 to-white rounded-sm">
          <ul className="hidden md:flex flex-row">
            <li className="text-slate-600 px-20 py-2 hover:font-bold h-[50px] w-[50px]">
              <RouterLink className="border-b-2 border-slate-700" to="/Home">
                Home
              </RouterLink>
            </li>
            <li className="text-slate-600 px-20 py-2 hover:font-bold h-[50px] w-[50px]">
          ...
          {!isDisplayed ? (
            <button className="md:hidden shadow-sm" onClick={handleDisplay}>
              <svg
            ...
            <div>
              <div className="absolute h-[300Px] w-[300px] bg-white border-2 border-gray-300 rounded-md">
                <div className="bg-blue-100 border-2 border-blue-200 flex flex-row-reverse">
                  {isDisplayed ? (
                    <button
                      className="rounded-sm w-7 h-7 bg-red-500 text-white"
                      onClick={handleClosed}
                    >
                      X
                    </button>
                  ) : (
                    <button className="md:hidden" onClick={handleDisplay}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
          ...
          <ul className="hidden md:flex flex-row justify-evenly">
            ...
            <li className="px-20 py-2">
              <img
                className="h-8 hover:scale-125 cursor-pointer"
                src={GitHub}
                alt="GitHub logo"
              />
            </li>
